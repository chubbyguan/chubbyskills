...
Current version: `0.11.1`. Release notes: [0.11.1](release-0.11.1.md).
...
2. Archive the directories as `chubbyskills-0.11.1-skills.tar.gz`, calculate SHA-256, then extract into a fresh directory and verify imports plus installed knowledge-base MCP.
...
Each skill bundles local code, license and version manifest; Python/system packages remain separate. Real user trials and seven-day reuse require participants; release checks do not complete [that research](user-pilot.md).
